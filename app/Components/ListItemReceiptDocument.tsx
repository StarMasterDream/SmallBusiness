...
import ItemRow from "./ItemRowReceiptDocument";
...
const ListItem = ({ item, theme }: { item: RemoteData; theme: string }) => {
  ...
  return (
    <TouchableOpacity style={styles.container} onPress={toggleRows} onLongPress={() => router.push({ pathname: "../Full_ItemReceiptDocument", params: { theme, ...item } })}>
