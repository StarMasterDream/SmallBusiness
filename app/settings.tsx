...
export default function SettingsScreen() {
  ...
  return (
    ...
    >
      ...
      <Text
        style={[styles.note, { color: theme === "light" ? "#888" : "#ddd" }]}
      >
        Автоматическая тема поддерживается только в операционных системах,
        которые позволяют управлять цветовой схемой на уровне всей системы.
      </Text>
    </View>
  );
}
