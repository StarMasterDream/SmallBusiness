...
interface ReceiptDocumentContextProps {
...
export const ReceiptDocumentContext = createContext<ReceiptDocumentContextProps>({
  remoteData: [],
  loading: false,
  error: null,
  refreshData: () => {},
...
export const ReceiptDocumentProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      if (!netState.isConnected) {
        setIsOffline(true);
        let cachedData = await loadCache("remoteDataReceiptDocument");
  ...
  return (
    <ReceiptDocumentContext.Provider
